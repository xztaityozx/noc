...
namespace Test {
    ...
    public class UnitTest2 {
        ...
        public void Encode004() {
            ...
            Assert.Equal("部邊邊󠄓邊󠄓邉邉󠄆邉󠄂邊邊󠄓邊󠄓邉邉󠄆邉󠄄邊邊󠄓邊󠄓邉邉󠄆邉󠄆部", new NabeEncoder().Encode(src));
        }
        ...
        public void Encode008() {
            ...
            Assert.Equal(
                "部邊邊󠄓邊󠄓邉邉󠄆邉󠄓邊邊󠄓邊󠄓邉邉󠄊邉󠄓邊邊󠄓邊󠄓邉邉󠄆辺邉󠄎邊邊󠄓邊󠄓邉邉󠄆辺邉󠄄邊邊󠄓邊󠄓邉邉󠄆辺邉󠄒部邊邊󠄀部邊邊󠄓邊󠄓邉邉󠄆邉󠄓邊邊󠄓邊󠄓邉邉󠄊邉󠄌邊邊󠄓邊󠄓邉邉󠄆辺邉󠄒部辺邉󠄊邉󠄋辺󠄂部邊邊󠄓邊󠄓邉邉󠄊辺邉󠄖邊邊󠄓邊󠄓邉邉󠄎辺邉󠄁邊邊󠄓邊󠄓邉邉󠄎辺邉󠄖邊邊󠄓邊󠄓邉邉󠄎邉󠄉邊邊󠄓邊󠄓邉邉󠄆辺邉󠄑部邉邉󠄓辺邉󠄁邉󠄏邉󠄐部邊邊󠄓邊󠄓邉邉󠄆辺邉󠄊邊邊󠄓邊󠄓邉邉󠄆邉󠄙邊邊󠄓邊󠄓邉邉󠄊邉󠄈邊辺󠄁辺󠄁辺邉󠄕邉邉󠄁部邊邊󠄍",
                new NabeEncoder().Encode(src));
        ...
        public void Encode009() {
            ...
            Assert.Equal("辺辺󠄀辺󠄁辺󠄂邉邉󠄀邉󠄁邉󠄂邊邊󠄐邊󠄑邊󠄒部邊邊󠄓邊󠄓邉邉󠄆邉󠄂邊邊󠄓邊󠄓邉邉󠄆邉󠄄邊邊󠄓邊󠄓邉邉󠄆邉󠄆部",
                new NabeEncoder().Encode(src));
        }
    }
    ...
    public class UnitTest3 {
        ...
        public void Decode004() {
            const string src = "部邊邊󠄓邊󠄓邉邉󠄆邉󠄂邊邊󠄓邊󠄓邉邉󠄆邉󠄄邊邊󠄓邊󠄓邉邉󠄆邉󠄆部";
        ...
        public void Decode008() {
            const string src = "部邊邊󠄓邊󠄓邉邉󠄆邉󠄓邊邊󠄓邊󠄓邉邉󠄊邉󠄓邊邊󠄓邊󠄓邉邉󠄆辺邉󠄎邊邊󠄓邊󠄓邉邉󠄆辺邉󠄄邊邊󠄓邊󠄓邉邉󠄆辺邉󠄒部邊邊󠄀部邊邊󠄓邊󠄓邉邉󠄆邉󠄓邊邊󠄓邊󠄓邉邉󠄊邉󠄌邊邊󠄓邊󠄓邉邉󠄆辺邉󠄒部辺邉󠄊邉󠄋辺󠄂部邊邊󠄓邊󠄓邉邉󠄊辺邉󠄖邊邊󠄓邊󠄓邉邉󠄎辺邉󠄁邊邊󠄓邊󠄓邉邉󠄎辺邉󠄖邊邊󠄓邊󠄓邉邉󠄎邉󠄉邊邊󠄓邊󠄓邉邉󠄆辺邉󠄑部邉邉󠄓辺邉󠄁邉󠄏邉󠄐部邊邊󠄓邊󠄓邉邉󠄆辺邉󠄊邊邊󠄓邊󠄓邉邉󠄆邉󠄙邊邊󠄓邊󠄓邉邉󠄊邉󠄈邊辺󠄁辺󠄁辺邉󠄕邉邉󠄁部邊邊󠄍";
            Assert.Equal(
        ...
        public void Decode009() {
            const string src = "辺辺󠄀辺󠄁辺󠄂邉邉󠄀邉󠄁邉󠄂邊邊󠄐邊󠄑邊󠄒部邊邊󠄓邊󠄓邉邉󠄆邉󠄂邊邊󠄓邊󠄓邉邉󠄆邉󠄄邊邊󠄓邊󠄓邉邉󠄆邉󠄆部";
